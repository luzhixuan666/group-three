...
import com.bawei.mall.pay.config.AlipayConfig;
import com.bawei.mall.pay.domain.AliPay;
        ...
        public String payNotify(HttpServletRequest request) throws Exception {
            if (request.getParameter("trade_status").equals("TRADE_SUCCESS")) {
                ...
                if (checkSignature) {
                    ...
                    // 查询订单
                    R<OrderInfo> info = remoteOrder.getInfoNumber(outTradeNo);
                    OrderInfo orderInfo = info.getData();
                    if (orderInfo!=null){
                        System.out.println("查询成功");
                        orderInfo.setStatus("pay_success");
                        orderInfo.setPayResult("success_pay");
                        orderInfo.setPayDeadlineTime(new Date());
                        remoteOrder.edit(orderInfo);
                    ...
                    payInfo.setOrderNumber(outTradeNo);
                    String totalAmount = params.get("total_amount");
                    Double aDouble = Double.valueOf(totalAmount);
                    payInfo.setPayPrice(BigDecimal.valueOf(aDouble));
                    payInfo.setPayType("online");
                    payInfo.setStatus("success_pay");
                    payInfo.setCreateBy(String.valueOf(userId));
